...
- [2026-05-16 F7 세션 work-log](../work-log/2026-05-16-armories-info-legacy-parity/index.md) — **F7 완료**: 본 문서의 concerns 모두 해소 (session 20260516-230225)
- [changes: F7 armories !정보 legacy parity](../changes/2026-05-16-armories-info-legacy-parity.md) — 런타임 변경 이력
